// Universal Orchestrator - Main Control (v13.0.9 Stable Restore)
// Este arquivo contém toda a lógica do sistema restaurada para a última versão funcional.
...
async function init() {
    console.log("🚀 Orquestrador v13.0.9 Ativo (Restore)");
    try {
        // Usa CONFIG definido em config.js
